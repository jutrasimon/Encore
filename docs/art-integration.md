...
Intégration visuelle 0.9.13, à partir de `ENCORE-Images-V1.zip` et du portrait fourni le 11 septembre 2026. Les PNG sources sont conservés sans retouche dans `dist/art/stage/`.
