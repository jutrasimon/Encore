import {focusCapacity} from './engine.js?v=0.9.18';
import {tileCard,esc} from './tile-ui.js?v=0.9.23';
export {tileDetails as inventoryEffect} from './tile-ui.js?v=0.9.23';
...
export function inventoryMarkup(p,{locked=false,draft=false}={}){
 ...
 }).join('')}</div>${draft?'<button class="action-button primary" data-action="draft">CONTINUER</button>':''}</section>`;
}
